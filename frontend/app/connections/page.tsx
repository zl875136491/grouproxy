...
export default function ConnectionsPage() {
  ...
  const connections = useQuery({ queryKey: ["connections"], queryFn: () => getConnections(), enabled: session === true, refetchInterval: 10_000 });
